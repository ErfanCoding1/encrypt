...
the timer project is simple timer that can be applied to other projects if it's needed.
time module is used to use sleep() fucntion form it to delay the program.
system function is used from os module to show the timer in system timer mode. -> system("cls")
